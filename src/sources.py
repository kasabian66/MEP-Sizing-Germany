...
"NPRO_HEATLOAD_WM2": Source(
    id="NPRO_HEATLOAD_WM2",
    title="nPro (Germany) — typical heating load (Heizlast) benchmarks by building type (rule-of-thumb)",
    url="https://www.npro.energy/main/de/load-profiles/heat-load-and-demand",
    accessed=ACCESS_DATE,
    kind="Guideline/Recommendation",
),
"KLIVATEC_COOLING_WM2": Source(
    id="KLIVATEC_COOLING_WM2",
    title="Klivatec (Germany) — rule-of-thumb cooling capacity guidance (W/m² ranges)",
    url="https://support.klivatec.de/hc/de/articles/22990547196188-Wie-berechne-ich-die-passende-K%C3%BChlleistung",
    accessed=ACCESS_DATE,
    kind="Guideline/Recommendation",
),
"SHK_AT_WORK_COOLING_WM2": Source(
    id="SHK_AT_WORK_COOLING_WM2",
    title="SHK-at-work — cooling sizing rule-of-thumb (W/m²) and note that VDI 2078 is the calculation basis",
    url="https://www.shk-at-work.de/wieviel-kuehlung-darfs-denn-sein_113059",
    accessed=ACCESS_DATE,
    kind="Guideline/Recommendation",
),
